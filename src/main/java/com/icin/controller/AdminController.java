...
public class AdminController {
	...
	@PutMapping(value="grantacs",consumes=MediaType.APPLICATION_JSON_VALUE)
	public String grantacs(@RequestBody Account ad) {
		return as.grantAccess(ad);
	}
	@PutMapping(value="blockacs",consumes=MediaType.APPLICATION_JSON_VALUE)
	public String blockacs(@RequestBody Account ad) {
		return as.blockAccess(ad);
	}
	...
	@PutMapping(value="chqstat", consumes=MediaType.APPLICATION_JSON_VALUE)
	public String chqacc(@RequestBody Account ad) {
		return ads.chqstatus(ad);
	}
